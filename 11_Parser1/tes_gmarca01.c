 ...
 *	tes_gmarca01.c
 *	
 *	genera archivo de marcas para lexer ...
 *
 * 	Opciones:
 * 	-h   		forma de uso
 *
 *
 * 	Input
 * 	archivo de tokens procesados por el parser tes_cpar0X, guardados en forma columnar 
 *
 * 	Output
 * 	archivo con tabla de marcas para usar luego en lexers 
 *
 *
 *
 * 	( mas ejemplos abajo )
 ...
 *
 *
 *	1) Modo normal ... archivo de input ... archivo de output 
 *
...
int	parser1()
{
	...
	while (fgets(b1, MAXB, hfinp) != NULL)
	{
		...
		if (strncmp (b1,"no",2) == 0)
		{
			strcpy(tk[0],"no");
			strcpy(tk[1],"no");
			strcpy(tk[2],"RN");
			strcpy(tk[3],"0.999297");
			strcpy(tk[4],"NEG");
		}

		if (strncmp (b1,"se",2) == 0)
		{
			strcpy(tk[0],"se");
			strcpy(tk[1],"ser");
			strcpy(tk[2],"VMI000");
		...
		if (strncmp (b1,"ni",2) == 0)
		{
			strcpy(tk[0],"ni");
			strcpy(tk[1],"ni");
			strcpy(tk[2],"CC");
			strcpy(tk[3],"0.834853");
			strcpy(tk[4],"CNEG");
		}

		if (strncmp (b1,"sin",3) == 0)
		{
			strcpy(tk[0],"sin");
			strcpy(tk[1],"sin");
			strcpy(tk[2],"SP");
		...
		if (strncmp (b1,"pero",4) == 0)
		{
			strcpy(tk[0],"pero");
			strcpy(tk[1],"pero");
			strcpy(tk[2],"CC");
			strcpy(tk[3],"0.999902");
			strcpy(tk[4],"ENDNEG");
		}

		if (strncmp (b1,"observ",6) == 0)
		{
			strcpy(tk[0],b1);
			strcpy(tk[1],"observar");
			strcpy(tk[2],"VMP");
			strcpy(tk[3],"0.999909");
			strcpy(tk[4],"OBS");
		}

		if (strncmp (b1,"detect",6) == 0)
		{
			strcpy(tk[0],b1);
			strcpy(tk[1],"detectar");
			strcpy(tk[2],"VMP");
			strcpy(tk[3],"0.999909");
			strcpy(tk[4],"DET");
		}

		if (strncmp (b1,"eviden",6) == 0)
		{
			strcpy(tk[0],b1);
			strcpy(tk[1],"evidenciar");
			strcpy(tk[2],"NCF");
			strcpy(tk[3],"0.850123");
			strcpy(tk[4],"EVI");
		}

		if (strncmp (b1,"visualiz",8) == 0)
		{
			strcpy(tk[0],b1);
			strcpy(tk[1],"visualizar");
			strcpy(tk[2],"VMI");
			strcpy(tk[3],"0.991255");
			strcpy(tk[4],"VIS");
		}

		if (strncmp (b1,"identif",7) == 0)
		{
			strcpy(tk[0],b1);
			strcpy(tk[1],"identificar");
			strcpy(tk[2],"VMN");
			strcpy(tk[3],"0.999999");
			strcpy(tk[4],"IDE");
		}
