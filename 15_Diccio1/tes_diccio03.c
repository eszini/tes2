 ...
 *	tes_diccio03.c
 *	
 *	Prepara la base para armar un diccionario
 *
 * 	Opciones:
 * 	-h   		forma de uso
 *
...
/*
 * 	diccio1
 * 	procesa lineas de tokens para generar base de diccio
 *
 *
 */
...
int	diccio1()
{
	...
	if (gp_verbose)
	{
		printf ("Cant de lineas    %6d\n",q_lin);
		printf ("Cant de palabras  %6d\n",q_pal);
	}
