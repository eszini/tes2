 ...
 *
 *	tes_filtro01  
 *	Realiza tareas de verificacion y filtrado en el archivo de corpus,
 *	necesarias para los procesos posteriores.
 *
 *	Input:
 *	Archivo de corpus, con formato :
 *	nro registro TAB referencia para busqueda de negacion TAB frase TAB affirmed | negated | posibility
